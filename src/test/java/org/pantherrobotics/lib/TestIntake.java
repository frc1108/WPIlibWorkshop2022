...
//     assertEquals(
//         0.0, m_simMotor.getDouble("Velocity").get(), DELTA,"Failed motor not running while retracted test"); // make sure that the value set to the motor is 0
//   }
...
//     assertEquals(0.5, m_simMotor.getDouble("Velocity").get(), DELTA, "Failed to run motor while deployed test");
//   }
